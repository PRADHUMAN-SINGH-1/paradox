// PARADOX Core Vertex Shader
// Real vertex noise displacement, audio reactivity, and mouse deformation
...
// Simplex 3D noise (inline optimized)
...
void main() {
  ...
  // Audio reactivity pushes outward pulses
  float audioBoost = uAudio * 0.45;
  
  // Vertex displacement along surface normal
  float disp = (totalNoise * uDisplacement * (0.8 + audioBoost));
  
  // Health factor: lower health causes erratic jitter
