...
export function bootCompare() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (leftRef.fullName.toLowerCase() === rightRef.fullName.toLowerCase()) throw new Error('Choose two different repositories to compare.');
    } catch (err) {
